...
public class JaxRsProviderTest {
	...
	public void testNameExtension() {
		Map<String, Object> properties = new HashMap<>();
		JaxRsExtensionProvider extProvider = new JerseyExtensionProvider<Object>(new TestExtension(), properties);
		// generated name
		assertEquals(Collections.emptyMap().toString(), extProvider.getName());
		...
		extProvider = new JerseyExtensionProvider<Object>(new TestExtension(), properties);
		// generated name
	...
	public void testNameResource() {
		Map<String, Object> properties = new HashMap<>();
		JaxRsResourceProvider resProvider = new JerseyResourceProvider<Object>(new TestExtension(), properties);
		// generated name
		assertEquals(Collections.emptyMap().toString(), resProvider.getName());
		...
		resProvider = new JerseyResourceProvider<Object>(new TestExtension(), properties);
		// generated name
