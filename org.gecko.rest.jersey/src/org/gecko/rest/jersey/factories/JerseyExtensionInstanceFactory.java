...
/**
 * HK2 creation factory for JaxRs extension instance. These factory instances will be bound using the {@link PrototypeServiceBinder}.
 * The factory is responsible to create or releasing a certain JaxRs extension instances, at request time.
...
//	private volatile Set<T> instanceCache = new HashSet<>();
	 ...
	 */
	public JerseyExtensionInstanceFactory(JaxRsApplicationContentProvider provider) {
